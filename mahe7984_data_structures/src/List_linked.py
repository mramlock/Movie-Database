...
class List:
    ...
    def prepend(self, value):
        ...
        """
        # your code here
        n = _List_Node(value, self._front)
    ...
    def reverse_r(self):
        ...
        if self._count > 1:
            ...
            self.reverse_r_aux(a, b)
        return

    def reverse_r_aux(self, a, b):
        """
        -------------------------------------------------------
        Reverses the order of the elements in list.
        (recursive algorithm)
    ...
    def is_identical_r(self, other):
        ...
        if self._count != other._count:
            ...
            s = self._front
            o = other._front
            identical = self.is_identical_r_aux(s, o, identical)
        return identical
    ...
    def split_alt_r(self):
        ...
        odd = List()
        l = True
        even, odd, l = self.split_alt_r_aux(even, odd, l)
        return even, odd

    def split_alt_r_aux(self, even, odd, l):
        """
        -------------------------------------------------------
        Split a list into two parts. even contains the even indexed
        elements, odd contains the odd indexed elements. At finish
        ...
        if self._front is not None:
            ...
            l = not l
            self.split_alt_r_aux(even, odd, l)
        return even, odd, l
    ...
    def intersection_r_aux(self, source1_node, source2):
        ...
        if source1_node is not None:
            v = source1_node._value
            _, current, _ = source2._linear_search_r(v)
            if current is not None:
                _, current, _ = self._linear_search(v)
                if current is None:
                    self.append(v)
    ...
    def _move_front_to_rear(self, source):
        ...
        t = source._front is None
        if t:
            source._rear = None
        t2 = self._rear is None
        if t2:
            self._front = a
        else:
            self._rear._next = a
